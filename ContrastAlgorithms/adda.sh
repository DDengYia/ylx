...
#CUDA_VISIBLE_DEVICES=0 python adda.py dataset/office31 -d Office31 -s A -t W -a resnet50 --epochs 20 --seed 1 --log logs/adda/Office31_A2W
...
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Ar -t Cl -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Ar2Cl
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Ar -t Pr -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Ar2Pr
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Ar -t Rw -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Ar2Rw
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Cl -t Ar -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Cl2Ar
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Cl -t Pr -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Cl2Pr
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Cl -t Rw -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Cl2Rw
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Pr -t Ar -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Pr2Ar
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Pr -t Cl -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Pr2Cl
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Pr -t Rw -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Pr2Rw
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Rw -t Ar -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Rw2Ar
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Rw -t Cl -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Rw2Cl
CUDA_VISIBLE_DEVICES=0 python adda.py datasetOfficeHome -d OfficeHome -s Rw -t Pr -a resnet50 --epochs 15 --seed 0 --log logs/adda/OfficeHome_Rw2Pr
#
