...
CUDA_VISIBLE_DEVICES=0 python fixmatch.py dataset/office31 -d Office31 -s A -t W -a resnet50 --lr 0.001 --bottleneck-dim 256 -ub 96 --epochs 20 --seed 0 --log logs/fixmatch/Office31_A2W
